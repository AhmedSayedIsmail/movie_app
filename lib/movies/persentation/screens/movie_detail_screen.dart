...
class MovieDetailContent extends StatelessWidget {
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: Constants.imageUrl(
                              imagePath: state.movieDetail!.image),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.movieDetail!.relaseDate.split('-')[1],
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            '${AppString.genresText}: ${_showGenres(state.movieDetail!.generes)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
                ...
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: FadeInUp(
                      ...
                      duration: const Duration(milliseconds: 500),
                      child: Text(
                        AppString.moreLikeText.toUpperCase(),
                        style: const TextStyle(
                          fontSize: 16.0,
                          fontWeight: FontWeight.w500,
                          letterSpacing: 1.2,
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      buildWhen: (previous, current) =>
          previous.movieRecomendationState != current.movieRecomendationState,
      builder: (context, state) {
        switch (state.movieRecomendationState) {
          case RequestState.loading:
            return const Center(child: CircularProgressIndicator());
          case RequestState.loaded:
            return SliverGrid(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  final recommendation = state.movieRecomendation[index];
                  return FadeInUp(
                    from: 20,
                    duration: const Duration(milliseconds: 500),
                    child: ClipRRect(
                ...
                childCount:state.movieRecomendation.length,
              ),
          ...
          case RequestState.error:
            return Center(
              child: Text(state.movieRecomendationMessage),
            );
        }
      },
    );
